...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      extendBody: true, // Allow body to extend behind app bar
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _buildStatItem("Watchlist",
                              userProvider.watchlist.length.toString()),
                          _buildStatItem("Liked",
                              userProvider.likedMovies.length.toString()),
                        ],
                      ),
                      const SizedBox(height: 30),
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isUnlocked =
                              unlockedCodes.contains(achievement.code);
